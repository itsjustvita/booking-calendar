...
export default function BookingEditModal({ isOpen, onClose, booking }: BookingEditModalProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[600px] border-white/20 bg-white/10 text-white backdrop-blur-xl">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-white/80">
                        Bearbeiten Sie die Details dieser Buchung.
                    </DialogDescription>
                </DialogHeader>
